...
contract KYC {
    ...
    // (4)	Block bank from adding new customers.
    ...
    function blockBankFromAddingNewCustomers(address add) public onlyadmin returns(int){
      ...
      // (5)	Allow bank from adding new customers
   ...
   //(8)	Add new customer request for kyc
